...
console.log('Reon Schutte once said,"The way to get started is to quit talking and begin doing"');
...
let message = 'once said,"The way to get started is to quit talking and begin doing"';
...
transportationMode.forEach((Mode) => console.log(`I would like to buy a ${Mode}`));
...
GuestList.forEach((invitation) => console.log(`"Hey ${invitation}, Let's make this weekend unforgettable with a cozy dinner at my place!
...
newGuestList.forEach((newinvitation) => console.log(`"Hey ${newinvitation}, Let's make this weekend unforgettable with a cozy dinner at my place!
     Come for the food, stay for the laughter.`));
/*___________________________________________________________________________________________________________________
------------------------------------------------- Question#16---------------------------------------------------------
...
console.log(`${moreGuests[0]} will unfortunately be unable to join us for dinner."`);
...
let middleGuest = Math.floor(moreGuests.length / 2);
moreGuests.splice(middleGuest, 0, "Asala");
moreGuests.forEach((moreinvitation) => console.log(`"Hey ${moreinvitation}, Let's make this weekend unforgettable with a cozy dinner at my place!
     Come for the food, stay for the laughter.`));
/*_________________________________________________________________________________________________________________
------------------------------------------ Question#17--------------------------------------------------------------
...
let mddleGust = Math.floor(shrinkGuestList.length / 2);
shrinkGuestList.splice(middleGuest, 0, "Asala");
shrinkGuestList.forEach((shrinkinvitation) => console.log(`"Hey ${shrinkinvitation}, Let's make this weekend unforgettable with a cozy dinner at my place!
     Come for the food, stay for the laughter.`));
...
new_usersNames.forEach((users) => {
    let condition01 = current_userNames.some((current_userNames1) => current_userNames1.toLowerCase() === users.toLowerCase());
    if (condition01) {
...
console.log("These animals share habits like grooming, exploring, social interaction, territoriality, feeding routines.");
...
*/
function make_Shirt(size1 = "large", printmessages = "I LOVE TYPEsCRIPT") {
...
*/
function city_country(city = "lahore", country = "PAKKISTAN") {
...
function show_magicians2(Magicians_Name2) {
    Magicians_Name2.forEach(Magicians => {
        console.log(Magicians);
    });
}
function make_great1(Magicians_Name2) {
...
function Sandwitch(...SandwitchItems) {
